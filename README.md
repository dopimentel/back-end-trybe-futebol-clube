...
<p align="center">
   ...
   <br>
   It is running in San Francisco on a DigitalOcean Droplet. Are three services (backend, frontend e DataBase - MySQL) running in Docker`s containners. It was set up by bash. Link demo:
